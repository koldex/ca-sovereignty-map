...
async def test_cname_exits_no_no_cname_record() -> None:
    ...
    with patch(
        "cert_sovereignty.resolve.resolve_robust", new_callable=AsyncMock, return_value=None
    ):
...
async def test_cname_exits_no_stays_within_no() -> None:
    ...
    with patch(
        "cert_sovereignty.resolve.resolve_robust", new_callable=AsyncMock, return_value=[rdata]
    ):
        assert await _cname_exits_no("laerdal.no") is False
...
async def test_tls_reachable_connection_refused() -> None:
    ...
    with patch(
        "asyncio.open_connection", new_callable=AsyncMock, side_effect=ConnectionRefusedError()
    ):
...
async def test_tls_reachable_success() -> None:
    ...
    with patch(
        "asyncio.open_connection", new_callable=AsyncMock, return_value=(MagicMock(), mock_writer)
    ):
...
async def test_validate_domain_rejects_no_dns() -> None:
    with patch(
        "cert_sovereignty.resolve.domain_resolves", new_callable=AsyncMock, return_value=False
    ):
...
async def test_validate_domain_rejects_cname_exit() -> None:
    ...
    with (
        patch(
            "cert_sovereignty.resolve.domain_resolves", new_callable=AsyncMock, return_value=True
        ),
        patch(
            "cert_sovereignty.resolve._cname_exits_no", new_callable=AsyncMock, return_value=True
        ),
    ):
...
async def test_validate_domain_rejects_tls_failure() -> None:
    ...
    with (
        ...
        patch(
            "cert_sovereignty.resolve._cname_exits_no", new_callable=AsyncMock, return_value=False
        ),
        patch(
            "cert_sovereignty.resolve._tls_reachable", new_callable=AsyncMock, return_value=False
        ),
    ):
...
async def test_validate_domain_accepts_bare_no_with_good_tls() -> None:
    ...
    with (
        ...
        patch("cert_sovereignty.resolve._tls_reachable", new_callable=AsyncMock, return_value=True),
    ):
...
async def test_validate_domain_skips_extra_checks_for_kommune() -> None:
    ...
    with (
        ...
        patch("cert_sovereignty.resolve._cname_exits_no", new_callable=AsyncMock) as mock_cname,
        patch("cert_sovereignty.resolve._tls_reachable", new_callable=AsyncMock) as mock_tls,
    ):
